...
namespace TreeLibrary.DragDropFramework
{
    ...
    public interface IDataProvider
    {
        ...
        bool IsSupportedContainerAndObject(bool initFlag, object dragSourceContainer, object dragSourceObject,
    ...
    public class DragManager
    {
        ...
        public DragManager(FrameworkElement dragSource, IDataProvider[] dragDropObjects)
        {
            ...
            this._dragSource.PreviewMouseLeftButtonUp +=
                new System.Windows.Input.MouseButtonEventHandler(DragSource_PreviewMouseLeftButtonUp);
        }
        ...
        private void DragSource_PreviewMouseMove(object sender, MouseEventArgs e)
        {
                    ...
                    ((FrameworkElement)e.OriginalSource).DataContext, e.OriginalSource))
            {
                ...
                if (((Math.Abs(currentPosition.X - this._startPosition.X) >
                     ...
                     (Math.Abs(currentPosition.Y - this._startPosition.Y) >
                      SystemParameters.MinimumVerticalDragDistance)))
                {
                    ...
                    if (this._dragDropObject.AddAdorner)
                    {
                        AdornerLayer.GetAdornerLayer((Visual) Application.Current.MainWindow.Content)
                            .Remove(this._dragDropObject.DragAdorner);
                    }
        ...
        private DragDropEffects DoDragDrop_Start(MouseEventArgs e)
        {
            ...
            {
                Debug.WriteLine("DragDrop.DoDragDrop threw an exception"+exception.ToString());
                e.Handled = true;
            }
