...
namespace ICMS.WPFControlsLibrary
{
    ...
    public partial class AutoComplete : ComboBox, IDisposable
    {
        ...
        {
            get { return this._typeAhead; }
            set { this._typeAhead = value; }
        }
        ...
        public string SelectedText
        {
            get
            {
                ...
                {
                    object value = base.SelectedItem.GetType().GetProperty(base.DisplayMemberPath)
                        .GetValue(base.SelectedItem, null);
                    if (value == null)
                    {
                        result = string.Empty;
                    }
        ...
        {
            get { return this._clearOnEmpty; }
            set { this._clearOnEmpty = true; }
        }


        public bool IsDropDownFromKeyEvent
        {
            get { return this._isDropDownFromKeyEvent; }
            set { this._isDropDownFromKeyEvent = value; }
        }
        ...
        private void _interval_Elapsed(object sender, ElapsedEventArgs e)
        {
            ...
            if (isKeyEvent)
            {
                base.Dispatcher.BeginInvoke(new Action(delegate
                {
                    ...
                    {
                        AutoComplete.AutoCompleteArgs autoCompleteArgs =
                            new AutoComplete.AutoCompleteArgs(this.EditableTextBox.Text);
        ...
        private void EditableTextBox_PreviewKeyDown(object sender, KeyEventArgs e)
        {
            if (e.Key != Key.Up && e.Key != Key.Down && e.Key != Key.Left && e.Key != Key.Right &&
                e.Key != Key.Return && e.Key != Key.LeftCtrl && e.Key != Key.RightCtrl && e.Key != Key.LeftAlt &&
                e.Key != Key.RightAlt && e.Key != Key.LeftShift && e.Key != Key.RightShift && e.Key != Key.Tab)
            {
                if (this.PatternChanged != null)
                {
        ...
        public class AutoCompleteArgs : EventArgs
        {
            ...
            {
                get { return this._cancelBinding; }
                set { this._cancelBinding = value; }
            }
